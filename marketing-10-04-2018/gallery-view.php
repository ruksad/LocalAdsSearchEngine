          ...
          <div class="top-bar">
            <div class="header-top-inner">
              <div class="dropdown">
                ...
                </ul> <a href="post-free-ad.php" class="btn btn-default post" type="button"><i class="fa fa-bullhorn"></i>&nbsp; Post Free Ad</a> <a href="#" class="btn btn-default" role="button" data-toggle="modal" data-target="#login-modal"><i class="fa fa-lock"></i>&nbsp; Login (or) Register</a> </div>
              <!-- /.cnt-account --> 
            </div>
            <!-- /.header-top-inner --> 
          </div>
      ...
      <div class="col-sm-2 col-md-2">
        <div class="panel-group" id="accordion">
          <div class="panel panel-default"> 
            <!--<div class="dash">              <p><a href="#">All Categories</a></p>            </div>-->
            <div class="panel-heading">
              <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Vehicles </a> </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
              <ul class="list-group">
                <li class="list-group-item"><a href="#">Cars</a>
                  <ul class="list-group">
                    <li class="list-group-item"><a href="#">Audi</a></li>
                    <li class="list-group-item"><a href="#">BMW</a></li>
                    <li class="list-group-item"><a href="#">Chevrolet</a></li>
                    <li class="list-group-item"><a href="#">Daewoo</a></li>
                    <li class="list-group-item"><a href="#">Fiat</a></li>
                    <li class="list-group-item"><a href="#">Ford</a></li>
                  </ul>
                </li>
                <li class="list-group-item"><a href="#"> Boats </a></li>
                <li class="list-group-item"><a href="#">Cycles</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="vehicles_list"> 
            ...
            <div class="vehiclesRow"> <a href="#">
              ...
              <div class="vehiclesMain">
                ...
                <span class="textHeader">Maruthi Suzuki Swift Desire Blue 2015 used, </span> <span class="textLoc">Pune</span> <span class="textDesc"><img src="images/Verified-Icon.png" alt=""></span> <span class="textKms">95000 kms</span> <span class="textDate">Feb 17</span> </div>
              </a> </div>
            <!-- vehiclesRow end --> 
            <!-- vehiclesRow start -->
            <div class="vehiclesRow"> <a href="#">
              ...
              <div class="col-md-3">
                <div data-toggle="modal" data-target="#vehicle_one" class="vehiclesGallery"> <a href="#">
                  <div class="vehiclesImage">
                    <p><img src="images/cars/car-1.jpg" alt=""></p>
                    <div class="add_info"> <i class="fa fa-rupee"></i>5,10,000 </div>
                  </div>
                  <div class="vehiclesMain">
                    <div class="textHeader ">Maruthi Suzuki Swift Desire, <span class="textLoc">Pune</span></div>
                  </div>
                  </a> </div>
              </div>
              <div class="col-md-3">
  ...
  <div class="modal-content mct"> 
    ...
    <div class="modal-header">
      ...
      <div class="car_icon">
        <ul>
          <li><a href="#">Home</a></li>
          <li><a href="#"><i class="fa fa-angle-right"></i>&nbsp; Vehicle</a></li>
          <li><a href="#"><i class="fa fa-angle-right"></i>&nbsp; Cars</a></li>
        </ul>
      </div>
    </div>
    <!-- modal-header end--> 
    ...
    <div class="modal-body">
      <h4 class="modal-title vap_headline">
        <div class="col-md-8"><span class="pull-left">Maruti Suzuki Swift Dzire 2015 <b style="font-size:25px;"><i class="fa fa-rupee"></i>5,10,000</b></span></div>
      ...
      <div class="car_detail">
        <div class="col-md-8"> 
          ...
          <div class="car_detail_lft">
            <div class="pull-left">Ad ID: 2112559894 </div>
            <div class="pull-right"><i class="fa fa-rupee"></i> <strong>5,10,000</strong> </div>
            <div class="vap_images">
              <div class="big_container"> 
                <!--  <p> <a href="#"> <img src="images/cars/bar_big.jpg" alt=""> </a> </p>--> 
                ...
                <div class="carousel slide article-slide" id="article-photo-carousel"> 
                  ...
                  <div class="carousel-inner cont-slider">
                    <div class="item active"> <img alt="" title="" src="images/cars/maruti_big_1.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/cars/maruti_big_2.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/cars/maruti_big_1.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/cars/maruti_big_2.jpg"> </div>
                  </div>
                  <!-- Indicators -->
                  <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#article-photo-carousel"> <img alt="" src="images/cars/maruti_sm_1.jpg"> </li>
                    <li class="" data-slide-to="1" data-target="#article-photo-carousel"> <img alt="" src="images/cars/maruti_sm_2.jpg"> </li>
                    <li class="" data-slide-to="2" data-target="#article-photo-carousel"> <img alt="" src="images/cars/maruti_sm_1.jpg"> </li>
                    <li class="" data-slide-to="3" data-target="#article-photo-carousel"> <img alt="" src="images/cars/maruti_sm_2.jpg"> </li>
                  </ol>
                </div>
                <!-- slider end here --> 
            ...
            <!--<div class="col-md-12 nopad">
              <div class="psn lft1"><i class="fa fa-chevron-left"></i></div>
              <div class="col-md-3">
                <div class="thumb"> <img src="images/cars/bar_big.jpg" alt=""></div>
              </div>
              <div class="col-md-3">
                <div class="thumb"><img src="images/cars/bar_big.jpg" alt=""></div>
              </div>
              ...
              <div class="psn rgt1"><i class="fa fa-chevron-right"></i></div>
            </div>-->
                  ...
                  <tbody>
                    <tr>
                      <td style="position:relative"><div id="vad">
                          <div>Description</div>
                          <div class="verna">2012 <a href="#">Hyundai</a> Verna [2011-2015] Fluidic 1.6 CRDi SX for sale in Rampur. The Crystal White Diesel Hyundai Verna [2011-2015] Fluidic 1.6 CRDi SX has done 63000 kms. Asking price is Rs.5,10,000 </div>
