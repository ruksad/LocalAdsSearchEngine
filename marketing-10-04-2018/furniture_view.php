        ...
        <div class="panel-group" id="accordion">
          <div class="panel panel-default"> 
            ...
            <div class="panel-heading">
              <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> Furniture </a> </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
              <ul class="list-group">
                <li class="list-group-item"><a href="#">Beds</a> 
                  <!--<ul class="list-group">
                ...
                <li class="list-group-item"><a href="#">Dining</a></li>
                <li class="list-group-item"><a href="#">Sofa </a></li>
                <li class="list-group-item"><a href="#">Home Decors</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="vehicles_list"> 
            ...
            <div class="vehiclesRow"> <a href="#">
              ...
              <div class="vehiclesMain">
                ...
                <span class="textHeader">Long lasting plywood of box Bed,</span> <span class="textLoc">Pune</span> <span class="textDesc"><img src="images/Verified-Icon.png" alt=""></span> <span class="textKms">450</span> <span class="textDate">Mar 15</span> </div>
              </a> </div>
            <!-- vehiclesRow end --> 
            <!-- vehiclesRow start -->
            <div class="vehiclesRow"> <a href="#">
              ...
              <div class="vehiclesMain">
                ...
                <span class="textHeader">Brown And White Wooden Wardrobe,</span> <span class="textLoc">Pune</span> <span class="textDesc"><img src="images/Verified-Icon.png" alt=""></span> <span class="textKms">500</span> <span class="textDate">Mar 15</span> </div>
              </a> </div>
            <!-- vehiclesRow end --> 
            <!-- Gallery-view start -->
            <div class="row">
              <div class="col-md-3">
                <div data-toggle="modal" data-target="#vehicle_one" class="vehiclesGallery"> <a href="#">
                  <div class="vehiclesImage">
                    <p><img src="images/furniture/sofa.jpg" alt=""></p>
                    <div class="add_info"> <i class="fa fa-rupee"></i>15,500 </div>
                  </div>
                  <div class="vehiclesMain">
                    <div class="textHeader ">Red Fabric L shape Sofa With Throw Pillows, <span class="textLoc">Pune</span></div>
                  </div>
                  </a> </div>
              </div>
              <div class="col-md-3">
                <div class="vehiclesGallery"> <a href="#">
                  <div class="vehiclesImage">
                    <p><img src="images/furniture/home-decors.jpg" alt=""></p>
                    <div class="add_info"> <i class="fa fa-rupee"></i>50,000 </div>
                  </div>
                  <div class="vehiclesMain">
                    <div class="textHeader ">Best of Home Decor Range, <span class="textLoc">Pune</span></div>
                  </div>
                  </a> </div>
              </div>
              <div class="col-md-3">
  ...
  <div class="modal-content mct"> 
    ...
    <div class="modal-body">
      <h4 class="modal-title vap_headline">
        <div class="col-md-8"><span class="pull-left">Red Fabric L shape Sofa With Throw Pillows <b style="font-size:25px;"><i class="fa fa-rupee"></i>15,500</b></span></div>
      ...
      <div class="car_detail">
        <div class="col-md-8"> 
          ...
          <div class="car_detail_lft">
            ...
            <div class="pull-right"><i class="fa fa-rupee"></i> <strong>15,500</strong> </div>
              ...
              <div class="big_container"> 
                ...
                <div class="carousel slide article-slide" id="article-photo-carousel"> 
                  ...
                  <div class="carousel-inner cont-slider">
                    <div class="item active"> <img alt="" title="" src="images/furniture/sofa_big1.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/furniture/sofa_big1.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/furniture/sofa_big1.jpg"> </div>
                    <div class="item"> <img alt="" title="" src="images/furniture/sofa_big1.jpg"> </div>
                  </div>
                  <!-- Indicators -->
                  <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#article-photo-carousel"> <img alt="" src="images/furniture/sofa_sm1.jpg"> </li>
                    <li class="" data-slide-to="1" data-target="#article-photo-carousel"> <img alt="" src="images/furniture/sofa_sm1.jpg"> </li>
                    <li class="" data-slide-to="2" data-target="#article-photo-carousel"> <img alt="" src="images/furniture/sofa_sm1.jpg"> </li>
                    <li class="" data-slide-to="3" data-target="#article-photo-carousel"> <img alt="" src="images/furniture/sofa_sm1.jpg"> </li>
                  </ol>
                </div>
                <!-- slider end here --> 
                      ...
                      <td style="position:relative"><div id="vad">
                          ...
                          <div id="cdt">
                            ...
                            <div>
                              ...
                              <div>Ready / Under Construction</div>
                            </div>
                            <div>
                              <div> Square Feet </div>
                              <div>1.551 ft2</div>
