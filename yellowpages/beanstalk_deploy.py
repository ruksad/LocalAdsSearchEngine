...
BUCKET_KEY = os.getenv('APPLICATION_NAME') + '/' + VERSION_LABEL + \
    '-yellowpages.jar'
artifact = '/opt/atlassian/pipelines/agent/build/target/yellowpages-0.0.1-SNAPSHOT.jar'
...
def main():
    ...
    if not upload_to_s3('/opt/atlassian/pipelines/agent/build/target/yellowpages-0.0.1-SNAPSHOT.jar'):
        sys.exit(1)
